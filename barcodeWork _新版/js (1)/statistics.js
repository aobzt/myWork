$(document).ready(function(){
	...
	/*$(document).on("click", "[button=switch]", function(){
		...
		switch($(this).attr("option"))
		{
			...
			case "percentage":
				...
				$("[pos=switchOne]").css("display", "block");
				$("[pos=switchTwo]").css("display", "none");
				$("[pos=switchThree]").css("display", "none");
				$("change[option=percentage]").removeClass("change-inactive").addClass("change-active");
				$("change[option=package]").removeClass("change-active").addClass("change-inactive");
        $("change[option=Time]").removeClass("change-active").addClass("change-inactive");
        
        break;
        
      case "package":
			
				$("[pos=switchOne]").css("display", "none");
				$("[pos=switchTwo]").css("display", "block");
				$("[pos=switchThree]").css("display", "none");
				$("change[option=percentage]").removeClass("change-active").addClass("change-inactive");
				$("change[option=package]").removeClass("change-inactive").addClass("change-active");
        $("change[option=Time]").removeClass("change-active").addClass("change-inactive");
        ...
        break;	  
			...
			case "Time":
				...
				$("[pos=switchOne]").css("display", "none");
				$("[pos=switchTwo]").css("display", "none");
				$("[pos=switchThree]").css("display", "block");
				$("change[option=percentage]").removeClass("change-active").addClass("change-inactive");
				$("change[option=package]").removeClass("change-active").addClass("change-inactive");
        $("change[option=Time]").removeClass("change-inactive").addClass("change-active");
	...
	$(document).on("click", "[go=TAT]", function(){
		...
		var collectPromise = new Promise(function(resolve, reject){
			...
			$.ajax({
				...
				success: function(response){
					...
					console.log("notCollectData:", notCollectData);
